 ...
 * @since 2.3.0
 */
export declare function getReaderValidation<E>(S: Semigroup<E>): Monad3C<URI, E> & Bifunctor3C<URI, E> & Alt3C<URI, E> & MonadThrow3C<URI, E>;
/**
 * @since 2.4.0
 */
export declare function fromEitherK<E, A extends Array<unknown>, B>(f: (...a: A) => Either<E, B>): <R>(...a: A) => ReaderEither<R, E, B>;
/**
 * @since 2.4.0
 */
export declare function chainEitherK<E, A, B>(f: (a: A) => Either<E, B>): <R>(ma: ReaderEither<R, E, A>) => ReaderEither<R, E, B>;
/**
 * @since 2.0.0
 */
