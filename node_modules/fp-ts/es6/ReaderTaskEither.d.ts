 ...
 * @since 2.0.0
 */
export declare function fold<R, E, A, B>(onLeft: (e: E) => ReaderTask<R, B>, onRight: (a: A) => ReaderTask<R, B>): (ma: ReaderTaskEither<R, E, A>) => ReaderTask<R, B>;
/**
 * @since 2.0.0
 */
export declare function getOrElse<R, E, A>(onLeft: (e: E) => ReaderTask<R, A>): (ma: ReaderTaskEither<R, E, A>) => ReaderTask<R, A>;
/**
 * @since 2.0.0
 */
 ...
 * @since 2.3.0
 */
export declare function getReaderTaskValidation<E>(S: Semigroup<E>): Monad3C<URI, E> & Bifunctor3C<URI, E> & Alt3C<URI, E> & MonadTask3C<URI, E> & MonadThrow3C<URI, E>;
/**
 * @since 2.4.0
 */
export declare function fromEitherK<E, A extends Array<unknown>, B>(f: (...a: A) => Either<E, B>): <R>(...a: A) => ReaderTaskEither<R, E, B>;
/**
 * @since 2.4.0
 */
export declare function chainEitherK<E, A, B>(f: (a: A) => Either<E, B>): <R>(ma: ReaderTaskEither<R, E, A>) => ReaderTaskEither<R, E, B>;
/**
 * @since 2.4.0
 */
export declare function fromIOEitherK<E, A extends Array<unknown>, B>(f: (...a: A) => IOEither<E, B>): <R>(...a: A) => ReaderTaskEither<R, E, B>;
/**
 * @since 2.4.0
 */
export declare function chainIOEitherK<E, A, B>(f: (a: A) => IOEither<E, B>): <R>(ma: ReaderTaskEither<R, E, A>) => ReaderTaskEither<R, E, B>;
/**
 * @since 2.4.0
 */
export declare function fromTaskEitherK<E, A extends Array<unknown>, B>(f: (...a: A) => TaskEither<E, B>): <R>(...a: A) => ReaderTaskEither<R, E, B>;
/**
 * @since 2.4.0
 */
export declare function chainTaskEitherK<E, A, B>(f: (a: A) => TaskEither<E, B>): <R>(ma: ReaderTaskEither<R, E, A>) => ReaderTaskEither<R, E, B>;
/**
 * @since 2.0.0
 */
