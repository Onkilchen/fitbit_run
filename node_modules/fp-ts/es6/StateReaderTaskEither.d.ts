 ...
 * @since 2.4.0
 */
export declare function fromEitherK<E, A extends Array<unknown>, B>(f: (...a: A) => Either<E, B>): <S, R>(...a: A) => StateReaderTaskEither<S, R, E, B>;
/**
 * @since 2.4.0
 */
export declare function chainEitherK<E, A, B>(f: (a: A) => Either<E, B>): <S, R>(ma: StateReaderTaskEither<S, R, E, A>) => StateReaderTaskEither<S, R, E, B>;
/**
 * @since 2.4.0
 */
export declare function fromIOEitherK<E, A extends Array<unknown>, B>(f: (...a: A) => IOEither<E, B>): <S, R>(...a: A) => StateReaderTaskEither<S, R, E, B>;
/**
 * @since 2.4.0
 */
export declare function chainIOEitherK<E, A, B>(f: (a: A) => IOEither<E, B>): <S, R>(ma: StateReaderTaskEither<S, R, E, A>) => StateReaderTaskEither<S, R, E, B>;
/**
 * @since 2.4.0
 */
export declare function fromTaskEitherK<E, A extends Array<unknown>, B>(f: (...a: A) => TaskEither<E, B>): <S, R>(...a: A) => StateReaderTaskEither<S, R, E, B>;
/**
 * @since 2.4.0
 */
export declare function chainTaskEitherK<E, A, B>(f: (a: A) => TaskEither<E, B>): <S, R>(ma: StateReaderTaskEither<S, R, E, A>) => StateReaderTaskEither<S, R, E, B>;
/**
 * @since 2.4.0
 */
export declare function fromReaderTaskEitherK<R, E, A extends Array<unknown>, B>(f: (...a: A) => ReaderTaskEither<R, E, B>): <S>(...a: A) => StateReaderTaskEither<S, R, E, B>;
/**
 * @since 2.4.0
 */
export declare function chainReaderTaskEitherK<R, E, A, B>(f: (a: A) => ReaderTaskEither<R, E, B>): <S>(ma: StateReaderTaskEither<S, R, E, A>) => StateReaderTaskEither<S, R, E, B>;
/**
 * @since 2.0.0
 */
