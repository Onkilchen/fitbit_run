 ...
 * @since 2.4.0
 */
export declare function fold<E, A, B>(onLeft: (e: E) => Task<B>, onRight: (a: A) => Task<B>, onBoth: (e: E, a: A) => Task<B>): (fa: TaskThese<E, A>) => Task<B>;
/**
 * @since 2.4.0
 */
...
declare const bimap: <E, G, A, B>(f: (e: E) => G, g: (a: A) => B) => (fa: TaskThese<E, A>) => TaskThese<G, B>, map: <A, B>(f: (a: A) => B) => <E>(fa: TaskThese<E, A>) => TaskThese<E, B>, mapLeft: <E, G>(f: (e: E) => G) => <A>(fa: TaskThese<E, A>) => TaskThese<G, A>;
export { 
/**
 * @since 2.4.0
 */
