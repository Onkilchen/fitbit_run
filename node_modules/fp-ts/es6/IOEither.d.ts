 ...
 * @since 2.0.0
 */
export declare function getIOValidation<E>(S: Semigroup<E>): Monad2C<URI, E> & Bifunctor2C<URI, E> & Alt2C<URI, E> & MonadIO2C<URI, E> & MonadThrow2C<URI, E>;
/**
 * @since 2.1.0
 */
 ...
 * @since 2.4.0
 */
export declare function fromEitherK<E, A extends Array<unknown>, B>(f: (...a: A) => Either<E, B>): (...a: A) => IOEither<E, B>;
/**
 * @since 2.4.0
 */
